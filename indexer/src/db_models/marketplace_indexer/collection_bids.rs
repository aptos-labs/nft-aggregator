...
use crate::{
    marketplace_schema::{collection_bids, filled_collection_bids},
...
pub struct CollectionBidOrderCanceledEventOnChain {
    ...
    pub fn to_db_collection_bid_and_filled_collection_bid(
        ...
        (
            CollectionBid {
                ...
                latest_order_filled_event_idx: tx_event_idx,
                order_cancelled_timestamp: 0,
                order_cancelled_tx_version: 0,
                order_cancelled_event_idx: 0,
...
impl CollectionBidOrderCanceledEventOnChain {
    pub fn to_db_collection_bid(
        &self,
        marketplace_addr: String,
        tx_version: i64,
